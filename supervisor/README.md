...
│   ├── App.tsx                     # header (StatusRing + ThemeToggle) + centred main (T24/T36)
│   ├── App.test.tsx                # renders-without-crashing Vitest test
│   ├── test-setup.ts               # jsdom DOM globals + localStorage + matchMedia stub (T24/T36)
